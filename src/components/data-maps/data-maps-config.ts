...
export const GAME_DETAILS_SECTIONS: SectionDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      { field: 'coin_toss_winner_team_id', type: 'string', nullable: true, key: 'FK', fkRef: 'teams.team_id', example: 'DET', description: 'Team that won the toss' },
      { field: 'coin_toss_decision', type: 'enum', nullable: true, example: 'receive', description: 'receive | defer | kick' },
    ],
  },
  {
    title: 'Game Recap',
  ...
  },
  {
    ...
    fields: [
      { field: 'game_id', type: 'string', nullable: false, key: 'PK', example: 'espn-401772947', description: 'Game reference' },
      { field: 'home_all_time_wins', type: 'number', nullable: false, example: '45', description: 'Home team all-time wins vs opponent' },
      { field: 'away_all_time_wins', type: 'number', nullable: false, example: '38', description: 'Away team all-time wins vs opponent' },
      { field: 'all_time_ties', type: 'number', nullable: false, example: '2', description: 'All-time ties' },
      { field: 'current_streak_team_id', type: 'string', nullable: true, key: 'FK', fkRef: 'teams.team_id', example: 'DET', description: 'Team on current streak' },
      { field: 'current_streak_count', type: 'number', nullable: false, example: '3', description: 'Current win streak count' },
      { field: 'last_meeting_date', type: 'date', nullable: true, example: '2024-12-15', description: 'Date of last matchup' },
      { field: 'last_meeting_winner_team_id', type: 'string', nullable: true, key: 'FK', fkRef: 'teams.team_id', example: 'DAL', description: 'Winner of last meeting' },
    ],
  },
  {
