...
export const GAME_DETAILS_SECTIONS: SectionDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { field: 'headline', type: 'string', nullable: true, example: 'Jahmyr Gibbs rushes for 3 TDs...', description: 'Article headline (planned)' },
      { field: 'summary', type: 'string', nullable: true, example: 'The Lions dominated...', description: 'Article summary (planned)' },
      { field: 'published_at', type: 'date', nullable: true, example: '2025-12-08T23:45:00Z', description: 'Publication timestamp (planned)' },
    ],
  },
  {
    title: 'Head to Head',
  ...
  },
  {
    ...
    recordCount: '~183 (2025: 174, 2024: 0 - needs backfill)',
